...
export default async function PortalPage({ searchParams }: PortalPageProps) {
  ...
  return (
    <AppShell eyebrow="Portal cliente" title="Tickets" description="Seguí las solicitudes de tu empresa y encontrá rápido qué requiere atención." tone="light"
      navigation={[{ href: "/portal", label: "Tickets", active: true, badge: stats.total }, { href: "/portal/users", label: "Usuarios" }]}
      sidebarFooter={<SidebarUserCard name={actor.name} detail="Cliente"><LogoutClientForm tone="light" /></SidebarUserCard>}
    ...
    >
      ...
      <SectionCard title="Listado de tickets" description="Estado, responsable, última actualización y próximo paso en una sola vista." tone="light">
        <TicketFilters basePath="/portal" query={filters.query} filters={[
