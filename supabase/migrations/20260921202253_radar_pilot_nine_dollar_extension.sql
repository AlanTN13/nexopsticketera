-- Alan explicitly authorized USD6 -> USD9 on 2026-09-21 for at most two further runs.
...
alter table private.radar_api_pilot_usage
  ...
  add constraint radar_api_pilot_usage_reserved_usd_check check (reserved_usd between 0 and 9.00);
...
begin
  ...
  if not found or reserved_count >= pilot_max_runs or reserved_dollars + 1.50 > 9.00 then
